...
- Keep per-feature change files in `.agentic/releases/` up to date for any PR that changes PLATE behavior; upgrade guidance should come from the release-note directory, not from chat history.
