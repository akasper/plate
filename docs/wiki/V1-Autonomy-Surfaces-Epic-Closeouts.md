...
| **#1000** | Adopter time-to-value polish (post-0.8.0 / Next Release) | **Close (first slice)** | Goals hybrid #993/#995; import-payload next_command #996/#997; install path 0.8.0 parity #998/#999; first-qa/session next_command #1001–#1004; merge Task #1006; offline proof docs; Phase A post-merge docs | LIVE under-30m proof remains human-gated E2E; do NOT claim #654 LIVE boxes; Next Release #983 still open; self-migrate residual UX if still relevant; children **7/7** |
