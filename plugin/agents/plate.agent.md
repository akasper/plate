...
- **Q&A / Curiosity:** use ask_user_question (native TUI) for PLATE Q&A; follow through on answers (artifacts per ACs). Use Question/contemplation MCP tools. Follow guidance sections.
