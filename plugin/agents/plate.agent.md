...
- Follow 'Long-running command / background task protocol' (from guidance) for background cmds in verification/babysit: record task_id, poll output, cheap fallback on kill.
